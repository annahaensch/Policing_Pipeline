"""OCR Tools for Police Call Log Data
"""
import cv2 as cv
import git
...
# eng.my-patterns is a textfile where each line contains special
# patterns that you would like to allow tesseract to identify.
# eng.my-words is a textfile where you can store special words
# (such as names or other proper nouns) that you'd like tesseract
# to identify.
